...
public interface IssueAndMrnItemWiseRepository extends JpaRepository<IssueAndMrnItemWise, Integer>{
	...
	List<IssueAndMrnItemWise> issueAndMrnItemWiseReportByGroupIdWithTypeIdAndIsDev1(@Param("fromDate")String fromDate,@Param("toDate") String toDate,
	...
	@Query(value=("SELECT\r\n" + 
			...
			"        m_item.is_used=1\r\n" + 
			"        and m_item.cat_id=:catId "),nativeQuery=true)
	List<IssueAndMrnItemWise> issueAndMrnGroupWisReportByCatId2(@Param("fromDate")String fromDate,@Param("toDate") String toDate,@Param("catId") int catId);
	...
	@Query(value=("SELECT\r\n" + 
			...
			"        m_item.is_used=1\r\n" + 
			"        and m_item.cat_id=:catId "),nativeQuery=true)
	List<IssueAndMrnItemWise> issueAndMrnGroupWisReportByGroupWithAllDevelopment3(@Param("fromDate")String fromDate,@Param("toDate") String toDate,
	...
	@Query(value=("SELECT\r\n" + 
			...
			"        m_item.is_used=1\r\n" + 
			"        and m_item.cat_id=:catId"),nativeQuery=true)
	List<IssueAndMrnItemWise> issueAndMrnGroupWisReportByCatIdWithAllType4(@Param("fromDate")String fromDate,@Param("toDate") String toDate,
