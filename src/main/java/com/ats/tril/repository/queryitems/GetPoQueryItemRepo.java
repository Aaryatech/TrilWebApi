...
/*
	@Query(value = " SELECT po_detail.po_detail_id,po_header.po_no,po_header.po_date,po_header.po_type,po_detail.item_qty,po_detail.inded_qty,po_detail.item_rate,indent.ind_m_no,indent.ind_m_date, "
			...
			+" AND po_header.po_id=po_detail.po_id AND po_detail.item_id=m_item.item_id AND po_header.vend_id=m_vendor.vendor_id\n" + 
			" AND po_detail.ind_id=indent.ind_m_id ", nativeQuery = true)
