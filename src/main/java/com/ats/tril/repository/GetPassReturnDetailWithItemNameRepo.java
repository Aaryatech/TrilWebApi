...
public interface GetPassReturnDetailWithItemNameRepo extends JpaRepository<GetPassReturnDetailWithItemName, Integer>{
	...
	@Query(value = "select gd.*,i.item_code from t_getpass_return_detail gd,m_item i where gd.return_id=:returnId and gd.is_used=1 and gd.gp_item_id = i.item_id ", nativeQuery = true)
