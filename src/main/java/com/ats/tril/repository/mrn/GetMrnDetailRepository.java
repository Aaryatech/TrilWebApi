...
public interface GetMrnDetailRepository extends JpaRepository<GetMrnDetail, Integer>{
	...
	@Query(value="select podetail.po_detail_id, podetail.pending_qty as po_pending_qty,d.mrn_qty as mrn_qty_before_edit,"
			...
			+ "d.remaining_qty,d.del_status  from t_mrn_detail d,m_item i,po_detail podetail where d.mrn_id=:mrnId and d.del_status=1 and i.item_id=d.item_id and d.mrn_detail_status=:mrnDetailStatus and podetail.po_detail_id=d.po_detail_id ",nativeQuery=true)
	...
	@Query(value="select podetail.po_detail_id,podetail.pending_qty as po_pending_qty,d.mrn_qty as mrn_qty_before_edit, d.mrn_detail_id,"
			...
			+ "d.reject_qty,d.reject_remark,d.mrn_detail_status,d.batch_no,d.issue_qty,d.remaining_qty,d.del_status  "
