...
public interface GetIntendDetailRepo extends JpaRepository<GetIntendDetail, Integer>{
	...
	@Query(value=("Select i.*,CONCAT(m.item_code, '-', m.item_desc) as item_code from indtrans i,m_item m where i.ind_m_id=:indId and m.item_id=i.item_id and i.del_status=1"),nativeQuery=true)
